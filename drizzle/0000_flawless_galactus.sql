...
CREATE INDEX "tasks_user_due" ON "tasks" USING btree ("user_id","due_date");--> statement-breakpoint
CREATE INDEX "tasks_user_parent" ON "tasks" USING btree ("user_id","parent_id");